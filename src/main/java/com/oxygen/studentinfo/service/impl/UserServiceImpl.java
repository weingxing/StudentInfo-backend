...
public class UserServiceImpl implements UserService {
    ...
    public Response changePassword(PasswordChanger passwordChanger) throws Exception {
        ...
        String oldPassword = RSAUtil.decrypt(CommonConfig.privateKey, passwordChanger.getOldPassword());
        String password = RSAUtil.decrypt(CommonConfig.privateKey, passwordChanger.getPassword());
